# Site Infrastructure — mattward.info

## Overview

This site is a static HTML/CSS/JS site hosted on **GitHub Pages**, with a custom domain managed through **Namecheap DNS**. There is no server, no build process, and no CDN configuration required — GitHub Pages handles all of that automatically.
...
The following DNS records are configured in Namecheap:
